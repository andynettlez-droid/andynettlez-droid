...
Studying for the **CCNA**, building Python/network automation reps, and tightening my GitHub, resume, and LinkedIn around network technician -> network automation engineer roles.

### Tech

Networking: TCP/IP, DNS, ARP, routing, Wi-Fi diagnostics, lab validation

Automation: Python, Ansible, Containerlab, Docker, GitHub Actions

Products: Node.js, Next.js, FastAPI, React, Stripe, Twilio-style messaging, Linux/systemd
